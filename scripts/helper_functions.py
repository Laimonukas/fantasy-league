...
def check_for_modifier(modifier_type: str,
    ...
    match modifier_type:
        ...
        case "kda 6+":
            mask = (((player_matches["deaths"] == 0) & (player_matches["kills"] + player_matches["assists"] >= 6)) |
                    ((player_matches["deaths"] > 0) & (player_matches["kills"] + player_matches["assists"]) / player_matches["deaths"] >= 6))
